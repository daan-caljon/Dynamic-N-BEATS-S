...
dataset = "M3_Monthly" # "M4_Monthly" or "M3_Monthly"
...
# setup
wandb_project_name = "M3_kappa_tuning" 
job_type_name = "validation_full"  # "test" or "validation_full" or "validation_earlystop"
...
def sweep_function():
    ...
    # Save forecasts
    file_name = dataset + "_" + job_type_name + "_" + config["balance_type"] + "_"+ run_name + ".csv"
    file_folder_name = os.path.join("Forecasts", dataset + "_" + config["balance_type"] + "_" + job_type_name)
...
sweep_config = {
    ...
    "parameters": {
        "rndseed": {
            "values": [2000,4000]  # 2000,4000,6000,8000,10000
        },
        "balance_type": {"values": ["rw"]},
        "lambda_cap": {"values": [0.025,0.05,0.075,0.1,0.125,0.15,0.175,0.2,0.225,0.25,0.275,0.3,0.325,0.35,0.375]},  # 0.025,0.05,0.075,0.1,0.125,0.15,0.175,0.2,0.225,0.25,0.275,0.3,0.325
        "learning_rate": {"values": [0.00001]},  # 0.0005,0.001,0.0025,0.005,0.01
        "epochs": {"values": [5000]},  # 4000,6000,8000,10000,12000 
    },
}
