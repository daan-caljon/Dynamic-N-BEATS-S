...
sweep_config = {
    ...
    "parameters": {
        ...
        "balance_type": {"values": ["gcossim"]},
        "preference_accuracy": {"values": [0.9]},  # 0.9,0.8,0.7,0.6,0.5
        "lambda": {"values": [0.2]},
        "hyperstep": {"values": [10]},  # 10,20,30,40,50
        "learning_rate": {"values": [0.0001]},  # 0.0005,0.001,0.0025,0.005,0.01
        "alpha": {"values": [1]},  # 0.0005,0.001,0.0025,0.005,0.01
        "epochs": {"values": [2]},  # 4000,6000,8000,10000,12000
    },
}
