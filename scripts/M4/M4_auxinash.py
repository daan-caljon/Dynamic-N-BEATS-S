...
# setup
wandb_project_name = "Auxinash_M4"
job_type_name = "test"
...
hyperparameter_defaults["preference_accuracy"] = (
    0.95  # This is the preference for accuracy (from 0 to 1) --> p_i = 1-preference_accuracy
)
hyperparameter_defaults["auto_p"] = True
hyperparameter_defaults["hyperstep"] = 10
hyperparameter_defaults["preference_lr"] = 0.01
...
sweep_config = {
    ...
    "parameters": {
        ...
        "balance_type": {"values": ["auxinash"]},
        "lambda": {"values": [0]},
        "learning_rate": {"values": [0.0005]},  # 0.0005,0.001,0.0025,0.005,0.01
