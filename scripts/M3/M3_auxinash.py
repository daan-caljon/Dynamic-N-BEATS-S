...
# setup
wandb_project_name = "auxinash_M3"
job_type_name = "test"
...
hyperparameter_defaults["preference_lr"] = 0.05
...
sweep_config = {
    ...
    "parameters": {
        ...
        "balance_type": {"values": ["auxinash"]}, # ["gradnorm", "no", "weighted gcossim", "gcossim","rw","nashmtl","auxinash"]
        "lambda": {"values": [0.025]},
