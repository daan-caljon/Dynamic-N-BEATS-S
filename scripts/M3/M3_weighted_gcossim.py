...
# setup
wandb_project_name = "Weighted_gcossim_M3"
job_type_name = "test"
...
sweep_config = {
    ...
    "parameters": {
        ...
        "balance_type": {"values": ["weighted gcossim"]}, # ["gradnorm", "no", "weighted gcossim", "gcossim","rw","nashmtl","auxinash"]
        "lambda": {"values": [0.025]},
        "learning_rate": {"values": [0.00001]},  # 0.0005,0.001,0.0025,0.005,0.01
        "epochs": {"values": [4000]},  # 4000,6000,8000,10000,12000
    },
}
