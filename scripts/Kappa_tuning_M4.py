...
# setup
wandb_project_name = "M4_kappa_tuning" 
...
sweep_config = {
    ...
    "parameters": {
        ...
        "lambda_cap": {"values": [0.025,0.05,0.075,0.1,0.125,0.15,0.175,0.2,0.225,0.25,0.275,0.3,0.325,0.35,
                                  0.375,0.4,0.425,0.45,0.475,0.5,0.525]},  # 0.025,0.05,0.075,0.1,0.125,0.15,0.175,0.2,0.225,0.25,0.275,0.3,0.325
        "learning_rate": {"values": [0.0001]},  # 0.0005,0.001,0.0025,0.005,0.01
        "epochs": {"values": [256]},  # 4000,6000,8000,10000,12000 
    },
}
